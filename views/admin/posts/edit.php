  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10 p-4">
        ...
        <div class="card">
          <div class="card-body">
            <form method="POST" action="/Mini-4/public/admin/posts/<?php echo $post['id']; ?>" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-8">
                  <!-- Tiêu đề -->
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Tóm tắt ngắn gọn về bài viết..."><?php echo htmlspecialchars($post['excerpt'] ?? ''); ?></textarea>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="border rounded p-2">
                        <img src="/Mini-4/public/<?php echo htmlspecialchars($post['featured_image']); ?>" 
                             ...
                             class="img-fluid" 
                             style="max-height: 150px; object-fit: <?php echo htmlspecialchars($post['image_fit'] ?? 'contain'); ?>;">
                      </div>
                    </div>
                  <?php endif; ?>
                  ...
                  <div class="mb-3">
                    <label for="featured_image" class="form-label">Thay đổi hình ảnh đại diện</label>
                  ...
                  <div class="mb-3">
                    ...
                    <select class="form-select" id="image_fit" name="image_fit">
                      <option value="contain" <?php echo ($post['image_fit'] == 'contain') ? 'selected' : ''; ?>>Vừa khung (contain)</option>
                      <option value="cover" <?php echo ($post['image_fit'] == 'cover') ? 'selected' : ''; ?>>Phủ khung (cover)</option>
                      <option value="fill" <?php echo ($post['image_fit'] == 'fill') ? 'selected' : ''; ?>>Lấp đầy (fill)</option>
                    </select>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="action" id="draft" value="draft" <?php echo ($post['status'] == 'draft') ? 'checked' : ''; ?>>
                      <label class="form-check-label" for="draft">
                        Lưu bản nháp
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="action" id="publish" value="publish" <?php echo ($post['status'] == 'published') ? 'checked' : ''; ?>>
