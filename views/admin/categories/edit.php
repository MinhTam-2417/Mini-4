  ...
  <div class="main-content">
    ...
    <div class="page-header">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h2 class="mb-1"><i class="bi bi-pencil-square"></i> Chỉnh sửa danh mục</h2>
    ...
    <div class="content-card">
      <form method="POST" action="/Mini-4/public/admin/categories/<?php echo $category['id']; ?>">
        <div class="row">
          <div class="col-md-8">
            <!-- Tên danh mục -->
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="description" name="description" rows="4" placeholder="Mô tả ngắn gọn về danh mục..."><?php echo htmlspecialchars($category['description'] ?? ''); ?></textarea>
          ...
          <div class="col-md-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="small text-muted mb-2">
                  <strong>Slug hiện tại:</strong> <code><?php echo htmlspecialchars($category['slug']); ?></code>
                </p>
                <p class="small text-muted mb-2">
                  <strong>Ngày tạo:</strong> <?php echo date('d/m/Y H:i', strtotime($category['created_at'])); ?>
                </p>
                <p class="small text-muted mb-0">
                  <strong>Slug mới:</strong> Sẽ được tạo tự động từ tên mới
                </p>
              </div>
            </div>
