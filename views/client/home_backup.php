                ...
                <div class="post-meta">
                  <div>
                    ...
                    <span class="like-count" data-post-id="<?php echo $post['id']; ?>" title="Hover để xem ai đã like">
                      <i class="bi bi-heart"></i> <?php echo $post['like_count'] ?? 0; ?> lượt thích
                    </span>
                  </div>
                  <div class="d-flex align-items-center gap-2">
                    <button class="like-btn btn btn-outline-danger btn-sm <?php echo ($post['user_liked'] ?? false) ? 'liked' : ''; ?>" 
                            data-post-id="<?php echo $post['id']; ?>" 
                            title="<?php echo ($post['user_liked'] ?? false) ? 'Bỏ thích' : 'Thích'; ?>">
                      <span class="like-icon">
                        <?php if ($post['user_liked'] ?? false): ?>
